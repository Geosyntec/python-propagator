...
Installing **python-propagator**
================================

**python-propagator** is an ArcGIS python toolbox and library for analyzing the extent of flooding and damage to assets under varying sea level rise and storm surge scenarios.
...
Downloading **python-propagator**
---------------------------------
An always current zipped archive of the tool can be downloaded at https://github.com/Geosyntec/python-propagator/archive/master.zip.
...
::
    ...
    C:\Users\phobson> cd C:\Users\phobson\Downloads\python-propagator-master

    C:\Users\phobson\Downloads\python-propagator-master> pip install .
...
At that point, **python-propagator** as been installed.
...
::
  ...
  C:\Users\phobson\Downloads\python-propagator-master> nosetests
  ........................................
  ----------------------------------------------------------------------
